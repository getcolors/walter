...
`workspace/standards/ssh-keypair.md`, contract 3): an absent machine-key value
selects keygen mode, where walter generates `.ssh/<profile>` next to
colors.yml on the first real create and delegates the standard's machinery to
